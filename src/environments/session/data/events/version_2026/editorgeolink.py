...
definitions = {
    ...
    # Mapping
        'remove_mapping' : EventDefinition(
                ...
                parameters=[
                        EventParameter('geolink_id', Type[int], aggregation=1, 
                                        api_description='CustomGeoLink IDs', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
        ...
        'set_mapping' : EventDefinition(
                ...
                parameters=[
                        EventParameter('geolink_id', Type[int], aggregation=1, 
                                        api_description='CustomGeoLink IDs', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('attribute', Type[str], aggregation=1, 
                                        api_description='Orginal Attribute Names', api_type=Type[str], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('new_attribute', Type[str], aggregation=1, 
                                        api_description='New Attribute Names', api_type=Type[str], api_required=True, api_default=None, api_aggregation=1,  ),
                    ]
            ),
    ...
    # Attribute
        ...
        'remove_matching' : EventDefinition(
                group='Attribute',
                parameters=[
                        EventParameter('geolink_id', Type[int], aggregation=1, 
                                        api_description='CustomGeoLink IDs', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
        ...
        'set_additional' : EventDefinition(
                group='Attribute',
                parameters=[
                        EventParameter('geolink_id', Type[int], aggregation=1, 
                                        api_description='CustomGeoLink IDs', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
        ...
        'remove_additional' : EventDefinition(
                group='Attribute',
                parameters=[
                        EventParameter('geolink_id', Type[int], aggregation=1, 
                                        api_description='CustomGeoLink IDs', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),

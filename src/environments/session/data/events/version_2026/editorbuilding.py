...
definitions = {
    ...
    # Sections
        ...
        'duplicate_section' : EventDefinition(
                group='Sections',
                parameters=[
                        EventParameter('building_id', Type[int], aggregation=1, 
                                        api_description='Building', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('section_id', Type[int], aggregation=1, 
                                        api_description='Section', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                    ]
            ),
    ...
    # Information
        ...
        'set_owner' : EventDefinition(
                ...
                parameters=[
                        EventParameter('building_id', Type[int], aggregation=1, 
                                        api_description='Buildings', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('stakeholder_id', Type[int], aggregation=1, 
                                        api_description='Stakeholders', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                    ]
            ),

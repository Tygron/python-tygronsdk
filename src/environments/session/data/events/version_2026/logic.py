...
definitions = {
    ...
    # Area
        ...
        'area_set_attribute' : EventDefinition(
                ...
                parameters=[
                        ...
                        EventParameter('update', Type[bool], False, 
                                        api_description='Update Indicators (optional)', api_type=Type[bool], api_required=False, api_default=None, api_aggregation=0,  ),
                    ]
            ),
    ...
    # Neighborhood
        'neighborhood_set_attribute' : EventDefinition(
                group='Neighborhood',
                parameters=[
                        EventParameter('neighborhood_id', Type[int], aggregation=1, 
                                        api_description='Neighborhood ID', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('attribute_name', Type[str], 
                                        api_description='Valid attribute name', api_type=Type[str], api_required=True, api_default=None, api_aggregation=0,  ),
                        EventParameter('attribute_value', Type[float], aggregation=1, 
                                        api_description='Attribute value', api_type=Type[float], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('update', Type[bool], False, 
                                        api_description='Update Indicators (optional)', api_type=Type[bool], api_required=False, api_default=None, api_aggregation=0,  ),
                    ]
            ),
    ...
    # Scenario
        'scenario_set_attribute' : EventDefinition(
                group='Scenario',
                parameters=[
                        EventParameter('scenario_id', Type[int], aggregation=1, 
                                        api_description='Scenario ID', api_type=Type[int], api_required=True, api_default=None, api_aggregation=1,  ),
                        EventParameter('attribute_name', Type[str], 
                                        api_description='Attribute Name', api_type=Type[str], api_required=True, api_default=None, api_aggregation=0,  ),
                        EventParameter('attribute_value', Type[float], aggregation=1, 
                                        api_description='Value', api_type=Type[float], api_required=True, api_default=None, api_aggregation=1,  ),

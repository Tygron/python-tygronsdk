...
definitions = {
    ...
    # General
        'add' : EventDefinition(
                group='General',
                parameters=[
                        EventParameter('overlay_type', ['INFERENCE', 'AREA', 'ATTRIBUTE', 'AVG', 'COMBO', 'DISTANCE', 'FLOODING', 'FUNCTION', 'GEO_TIFF', 'GROUNDWATER', 'HEAT_STRESS', 'HEIGHTMAP', 'IMAGE', 'ITERATION', 'LIVABILITY', 'MUNICIPALITIES', 'NEIGHBORHOODS', 'NETWORK_DISTANCE', 'NETWORK_OVERVIEW', 'NETWORK_OWNERSHIP', 'OWNERSHIP', 'OWNERSHIP_GRID', 'RAINFALL', 'RESULT_CHILD', 'SATELLITE', 'SCENARIO', 'SHADOW', 'SIGHT_DISTANCE', 'SOURCE', 'TEST', 'TRAFFIC_DENSITY', 'TRAFFIC_NO2', 'TRAFFIC_NOISE', 'TRAVEL_DISTANCE', 'UNDERGROUND', 'WATERSHED', 'WCS', 'WMS', 'ZIP_CODES', 'ZONING'], 
                                        api_description='OverlayType;{"default": null, "values": ["INFERENCE", "AREA", "ATTRIBUTE", "AVG", "COMBO", "DISTANCE", "FLOODING", "FUNCTION", "GEO_TIFF", "GROUNDWATER", "HEAT_STRESS", "HEIGHTMAP", "IMAGE", "ITERATION", "LIVABILITY", "MUNICIPALITIES", "NEIGHBORHOODS", "NETWORK_DISTANCE", "NETWORK_OVERVIEW", "NETWORK_OWNERSHIP", "OWNERSHIP", "OWNERSHIP_GRID", "RAINFALL", "RESULT_CHILD", "SATELLITE", "SCENARIO", "SHADOW", "SIGHT_DISTANCE", "SOURCE", "TEST", "TRAFFIC_DENSITY", "TRAFFIC_NO2", "TRAFFIC_NOISE", "TRAVEL_DISTANCE", "UNDERGROUND", "WATERSHED", "WCS", "WMS", "ZIP_CODES", "ZONING"]}', api_type=['INFERENCE', 'AREA', 'ATTRIBUTE', 'AVG', 'COMBO', 'DISTANCE', 'FLOODING', 'FUNCTION', 'GEO_TIFF', 'GROUNDWATER', 'HEAT_STRESS', 'HEIGHTMAP', 'IMAGE', 'ITERATION', 'LIVABILITY', 'MUNICIPALITIES', 'NEIGHBORHOODS', 'NETWORK_DISTANCE', 'NETWORK_OVERVIEW', 'NETWORK_OWNERSHIP', 'OWNERSHIP', 'OWNERSHIP_GRID', 'RAINFALL', 'RESULT_CHILD', 'SATELLITE', 'SCENARIO', 'SHADOW', 'SIGHT_DISTANCE', 'SOURCE', 'TEST', 'TRAFFIC_DENSITY', 'TRAFFIC_NO2', 'TRAFFIC_NOISE', 'TRAVEL_DISTANCE', 'UNDERGROUND', 'WATERSHED', 'WCS', 'WMS', 'ZIP_CODES', 'ZONING'], api_required=True, api_default=None, api_aggregation=0,  ),
                    ]
            ),
        'add_type' : EventDefinition(
                group='General',
                parameters=[
                        EventParameter('overlay_type', ['AREAS', 'ATTRIBUTE', 'AVG', 'COMBO', 'DISTANCE_SIGHT', 'DISTANCE_ZONE', 'DISTURBANCE_DISTANCE', 'FLOODING', 'FUNCTION_HIGHLIGHT', 'GEO_TIFF', 'GROUNDWATER', 'HEAT_STRESS', 'HEIGHTMAP', 'IMAGE', 'LIVABILITY', 'MUNICIPALITIES', 'NEIGHBORHOODS', 'NETWORK_DISTANCE', 'NETWORK_OVERVIEW', 'NETWORK_OWNERSHIP', 'OWNERSHIP', 'OWNERSHIP_GRID', 'RAINFALL', 'RESULT_CHILD', 'SAFETY_DISTANCE', 'SOURCE', 'SUBSIDENCE', 'TEST', 'TRAFFIC_DENSITY', 'TRAFFIC_NO2', 'TRAFFIC_NOISE', 'TRAVEL_DISTANCE', 'UNDERGROUND', 'VACANCY', 'WATERSHED', 'WCS', 'WMS', 'ZIP_CODES', 'ZONING'], aggregation=1, 
        ...
        'set_prequel' : EventDefinition(
                ...
                parameters=[
                        ...
                        EventParameter('iterational_input', Type[bool], False, 
                                        api_description='Previous Iteration (optional)', api_type=Type[bool], api_required=False, api_default=None, api_aggregation=0,  ),
                    ]
            ),
    ...
    # Overlay: Functions
        ...
        'add_overlay_function' : EventDefinition(
                ...
                parameters=[
                        EventParameter('overlay_id', Type[int], 
                                        api_description='Overlay ID (must relate to a FUNCTION Overlay)', api_type=Type[int], api_required=True, api_default=None, api_aggregation=0,  ),

    ...
    # Calculation model
        ...
        'set_function_value' : EventDefinition(
                ...
                parameters=[
                        ...
                        EventParameter('function_value_name', ['ALIGN_ELEVATION', 'BASEMENT_COLOR', 'BASEMENT_HEIGHT_M', 'BOWEN_RATIO', 'CRITICAL_INFRASTRUCTURE', 'DEFAULT_FLOORS', 'DISTANCE_ZONE_M', 'DISTURBANCE_DISTANCE_M', 'DRAINAGE', 'EXTRA_COLOR', 'FLOOR_HEIGHT_M', 'FOLIAGE_CROWN_FACTOR', 'GREEN_M2', 'GROUND_COLOR', 'GROUND_INFILTRATION_MD', 'HEAT_EFFECT', 'HEIGHT_OFFSET_M', 'JAM_FACTOR_BUSES', 'JAM_FACTOR_CARS', 'JAM_FACTOR_TRUCKS', 'JAM_FACTOR_VANS', 'LIVABILITY_EFFECT', 'MAX_FLOORS', 'MIN_FLOORS', 'MONUMENTAL', 'NUM_AIRPLANES', 'NUM_BICYCLES', 'NUM_BUSES', 'NUM_CARS', 'NUM_PEDESTRIANS', 'NUM_SHIPS', 'NUM_TRAINS', 'NUM_TRAMS', 'NUM_TRUCKS', 'NUM_VANS', 'PIPES_PERMITTED', 'ROOF_COLOR', 'ROOT_DEPTH_M', 'SAFETY_DISTANCE_M', 'SEWERED', 'SLANTING_ROOF_HEIGHT', 'SOLAR_PANELS', 'SOLID', 'TERRAIN_MIX', 'TOP_COLOR', 'TRAFFIC_LANES', 'TRAFFIC_NOISE_SIGMA', 'TRAFFIC_NOISE_TAU', 'TRAFFIC_SPEED', 'WATER_EVAPORATION_FACTOR', 'WATER_MANNING', 'WATER_STORAGE_M2', 'ZONING_PERMIT_REQUIRED'], 
                                        api_description='FunctionValue;{"default": null, "values": ["ALIGN_ELEVATION", "BASEMENT_COLOR", "BASEMENT_HEIGHT_M", "BOWEN_RATIO", "CRITICAL_INFRASTRUCTURE", "DEFAULT_FLOORS", "DISTANCE_ZONE_M", "DISTURBANCE_DISTANCE_M", "DRAINAGE", "EXTRA_COLOR", "FLOOR_HEIGHT_M", "FOLIAGE_CROWN_FACTOR", "GREEN_M2", "GROUND_COLOR", "GROUND_INFILTRATION_MD", "HEAT_EFFECT", "HEIGHT_OFFSET_M", "JAM_FACTOR_BUSES", "JAM_FACTOR_CARS", "JAM_FACTOR_TRUCKS", "JAM_FACTOR_VANS", "LIVABILITY_EFFECT", "MAX_FLOORS", "MIN_FLOORS", "MONUMENTAL", "NUM_AIRPLANES", "NUM_BICYCLES", "NUM_BUSES", "NUM_CARS", "NUM_PEDESTRIANS", "NUM_SHIPS", "NUM_TRAINS", "NUM_TRAMS", "NUM_TRUCKS", "NUM_VANS", "PIPES_PERMITTED", "ROOF_COLOR", "ROOT_DEPTH_M", "SAFETY_DISTANCE_M", "SEWERED", "SLANTING_ROOF_HEIGHT", "SOLAR_PANELS", "SOLID", "TERRAIN_MIX", "TOP_COLOR", "TRAFFIC_LANES", "TRAFFIC_NOISE_SIGMA", "TRAFFIC_NOISE_TAU", "TRAFFIC_SPEED", "WATER_EVAPORATION_FACTOR", "WATER_MANNING", "WATER_STORAGE_M2", "ZONING_PERMIT_REQUIRED"]}', api_type=['ALIGN_ELEVATION', 'BASEMENT_COLOR', 'BASEMENT_HEIGHT_M', 'BOWEN_RATIO', 'CRITICAL_INFRASTRUCTURE', 'DEFAULT_FLOORS', 'DISTANCE_ZONE_M', 'DISTURBANCE_DISTANCE_M', 'DRAINAGE', 'EXTRA_COLOR', 'FLOOR_HEIGHT_M', 'FOLIAGE_CROWN_FACTOR', 'GREEN_M2', 'GROUND_COLOR', 'GROUND_INFILTRATION_MD', 'HEAT_EFFECT', 'HEIGHT_OFFSET_M', 'JAM_FACTOR_BUSES', 'JAM_FACTOR_CARS', 'JAM_FACTOR_TRUCKS', 'JAM_FACTOR_VANS', 'LIVABILITY_EFFECT', 'MAX_FLOORS', 'MIN_FLOORS', 'MONUMENTAL', 'NUM_AIRPLANES', 'NUM_BICYCLES', 'NUM_BUSES', 'NUM_CARS', 'NUM_PEDESTRIANS', 'NUM_SHIPS', 'NUM_TRAINS', 'NUM_TRAMS', 'NUM_TRUCKS', 'NUM_VANS', 'PIPES_PERMITTED', 'ROOF_COLOR', 'ROOT_DEPTH_M', 'SAFETY_DISTANCE_M', 'SEWERED', 'SLANTING_ROOF_HEIGHT', 'SOLAR_PANELS', 'SOLID', 'TERRAIN_MIX', 'TOP_COLOR', 'TRAFFIC_LANES', 'TRAFFIC_NOISE_SIGMA', 'TRAFFIC_NOISE_TAU', 'TRAFFIC_SPEED', 'WATER_EVAPORATION_FACTOR', 'WATER_MANNING', 'WATER_STORAGE_M2', 'ZONING_PERMIT_REQUIRED'], api_required=True, api_default=None, api_aggregation=0,  ),

...
definitions = {
    ...
    # Session
        ...
        'zoomlevel_set_active' : EventDefinition(
                group='Session',
                parameters=[
                        EventParameter('zoomlevel_id', Type[int], 
                                        api_description='Zoomlevel ID', api_type=Type[int], api_required=True, api_default=None, api_aggregation=0,  ),

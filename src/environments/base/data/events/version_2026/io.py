...
definitions = {
    ...
    # Available projects data
        'get_domain_projects' : EventDefinition(
                group='Available projects data',
                parameters=[
                    ]
            ),
        'get_project' : EventDefinition(
                group='Available projects data',
                parameters=[
                        EventParameter('project_name', Type[str], 
                                        api_description='Project Name', api_type=Type[str], api_required=True, api_default=None, api_aggregation=0,  ),
        ...
        'get_startable_projects' : EventDefinition(
                group='Available projects data',
                parameters=[
                    ]
            ),
        'get_startable_templates' : EventDefinition(
                group='Available projects data',
                parameters=[
                    ]
            ),
    ...
    # Available sessions data
        'get_sessions' : EventDefinition(
                group='Available sessions data',
                parameters=[
                    ]
            ),
        'get_joinable_sessions' : EventDefinition(
                group='Available sessions data',
                parameters=[
                    ]
            ),
    ...
    # Server status
        ...
        'get_intro_message' : EventDefinition(
                group='Server status',
                parameters=[
                    ]
            ),
